...
public class frmTransaksi extends javax.swing.JFrame {
    ...
    private void simpan_transaksi() {
        ...
        PreparedStatement pstmtJual = null;
        PreparedStatement pstmtDjual = null;
        ...
        try {
            ...
            pstmtJual = Con.prepareStatement(sqlInsertJual);
            pstmtJual.setString(1, xnojual);
            pstmtJual.setString(2, xkode);
            pstmtJual.setString(3, tanggal);
            pstmtJual.executeUpdate();

            // Insert into djual table
            pstmtDjual = Con.prepareStatement(sqlInsertDjual);
            for (int i = 0; i < tblJual.getRowCount(); i++) {
                ...
                pstmtDjual.setString(1, xnojual);
                pstmtDjual.setString(2, xkd);
                pstmtDjual.setDouble(3, xhrg);
                pstmtDjual.setInt(4, xjml);
              
                pstmtDjual.addBatch();
            }
            pstmtDjual.executeBatch();
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Error rollback: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            }
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        } finally {
    ...
    public void itemTerpilih() {
        ...
        fDB.fAB = this; // Mengacu pada instance frmTransaksi yang sedang aktif
        fDB.setVisible(true);
        txtId.setText(idBrg);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(cmdHapusItem, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtTot, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addComponent(cmbKd_Kons, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(19, 19, 19)
